...
import {
  ...
  SIGN_IN_URL,
  type UploadedFile,
} from './fileColumnService'

// One screen: pick a file, upload it, see your files, download or delete them.
// All the Web API work lives in fileColumnService.ts.
export default function App() {
    ...
    return (
      <main className="card">
        ...
        <p className="subtitle">
          Files are stored in a Dataverse File column on your own record. Sign in
  ...
  return (
    <main className="card">
      <h1>My documents</h1>
      <p className="subtitle">
        Files are stored in a native Dataverse <strong>File column</strong> on a
        record you own, uploaded and downloaded through the Power Pages Web API.
      </p>
