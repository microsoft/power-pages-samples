...
| [Unbound Custom API Invocation](unbound-custom-api/) | Dataverse Custom APIs | Invoke an unbound Custom Action with `POST` and an unbound Custom Function with `GET` from server logic using a ready-to-import solution. |
