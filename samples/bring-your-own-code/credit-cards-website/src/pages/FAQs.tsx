    ...
    <div className="mx-auto my-8 px-4">
      <div className="text-center mb-12 relative py-12 bg-gradient-to-b from-gray-900/70 to-gray-900/30 rounded-xl">
        ...
        <div className="mx-auto max-w-3xl px-4">
          ...
          <div className="absolute inset-0 bg-white rounded-xl opacity-20 blur-sm -z-10"></div>
          <input
            type="text"
            ...
            className="w-full p-5 pl-14 border-2 border-white/40 bg-white/90 rounded-xl shadow-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-300 text-lg font-medium placeholder-gray-500 text-gray-800"
          />
      ...
      <div className="bg-white shadow-xl rounded-xl px-8 py-10 max-w-4xl mx-auto mt-10 border border-gray-100">
        <FAQSection faqs={ filteredFAQs } />
      </div>      <div className="mt-16 text-center bg-gradient-to-br from-indigo-50 to-blue-50 py-12 px-6 rounded-xl shadow-lg max-w-4xl mx-auto">
        <h2 className="text-3xl font-bold text-gray-900 mb-6">Still have questions?</h2>
        <p className="text-xl text-gray-700 mb-8 max-w-2xl mx-auto">
          If you didn't find the answer you're looking for, our support team is here to help! Reach out to us through our <a href="/contact" className="text-indigo-600 hover:text-indigo-800 font-medium">contact page</a>.
        </p>
