...
const Application: React.FC = () => {
  ...
  return (
    <div className="max-w-screen-lg mx-auto p-6">
      ...
      <section className="bg-gray-100 p-10 rounded-xl shadow-lg max-w-3xl mx-auto w-full mb-8">
        ...
        { isAuthenticated ? (
          ...
          <div className="text-center py-6">
            <p className="text-lg mb-4">Please sign in to access the application form.</p>
