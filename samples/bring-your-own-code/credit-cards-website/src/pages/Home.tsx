...
const Home: React.FC = () => {
  ...
  return (
    <div className="container mx-auto my-4 px-4 lg:px-8">
      <h1 className="text-5xl font-extrabold text-center mb-8 bg-gradient-to-r from-blue-600 to-indigo-900 text-white p-4 rounded-lg shadow-lg animate-fade-in glass">
        WoodGrove Bank Credit Cards
      </h1>
      <p className="text-center mb-8 text-gray-800 text-lg animate-fade-in delay-200 glass p-4 rounded-lg">
      ...
      {/* 🔥 Stylish Pill Tabs for Navigation */ }
      <div className="flex overflow-x-auto space-x-4 mb-8 scrollbar-hide p-2 border-b border-gray-300 justify-center glass rounded-full my-4">
        { cardTypes.map((type) => (
          <button
            key={ type }
      ...
      {/* Card Section */ }
      <section className="mb-12 glass p-6 rounded-xl">
        <h2 className="text-3xl font-bold text-blue-600 mb-4 animate-slide-in-left">
        ...
        { isLoading ? (
          ...
          <div className="overflow-hidden relative">
            <div className="flex gap-6 overflow-x-auto scrollbar-hide snap-x snap-mandatory px-8 py-4">
              { filteredCards.map((card, index) => (
                <div
                  key={ index }
                  className={ `min-w-[300px] snap-center flex-shrink-0 transform transition-transform duration-500 ease-in-out hover:scale-110 hover:rotate-3 hover:shadow-2xl shadow-md rounded-xl p-4 hover:-translate-y-2 hover:ring-2 hover:ring-indigo-500 hover:ring-offset-2 animate-pop ${index % 2 === 0 ? "bg-gradient-to-br from-white to-gray-100" : "bg-gradient-to-br from-indigo-100 to-blue-200"
                    }` }
                >
          ...
          <p className="text-center text-gray-600 animate-fade-in">No cards available.</p>
        ) }
      </section>

      {/* Latest Offers Section */ }
      <section className="mb-12 glass p-6 rounded-xl">
        <h2 className="text-3xl font-bold text-purple-600 mb-4 animate-slide-in-right">Latest Offers</h2>
