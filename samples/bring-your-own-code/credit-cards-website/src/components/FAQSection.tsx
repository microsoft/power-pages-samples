    ...
    <div className="py-2 space-y-4">
      { faqs.length === 0 ? (
        ...
        faqs.map((faq) => (
          <div
            key={ faq.id }
            className={ `rounded-lg border ${openFAQ === faq.id ? 'border-indigo-300 shadow-md bg-indigo-50' : 'border-gray-200'}` }
          >            <div
          ...
          >
              ...
              <span className="text-indigo-600 bg-indigo-100 rounded-full h-8 w-8 flex items-center justify-center">
                { openFAQ === faq.id ? (
