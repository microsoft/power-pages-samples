...
const ApplyCardBenefits: React.FC = () => {
  ...
  return (
    <div className="relative bg-gradient-to-br from-blue-100 to-blue-50 p-8 rounded-2xl shadow-lg ring-1 ring-blue-200">
      <h2 className="text-3xl font-extrabold mb-5 text-blue-900 text-center">
