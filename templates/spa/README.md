...
| Preview | Template | Framework | Scenario | Includes |
| --- | --- | --- | --- | --- |
...
1. Import the unmanaged solution zip listed in the template README.
1. Import `seed/data.json` separately if the template includes seed data.
