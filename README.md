...
| <img src="samples/spa/react/file-upload-sample/screenshot.png" alt="File upload sample screenshot" width="180" /> | [File Upload Sample](samples/spa/react/file-upload-sample/) | React | Upload, list, download, and delete files via the Web API, stored as Dataverse notes (annotations). |
